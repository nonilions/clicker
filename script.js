...
if (cBtn) {
    cBtn.onclick = function(e) {
        ...
        setTimeout(function() { cBtn.classList.remove('active-click'); }, 80);
    };
}
if (upCBtn) {
...
if (musicToggle) {
    musicToggle.onclick = function() {
        ...
        if (bgM.paused) {
            ...
            }).catch(function() { alert("Click game first!"); });
        } else {
            bgM.pause();
...
window.addEventListener("keydown", function(e) {
    ...
    clearTimer = setTimeout(function() { inputBuffer = ""; }, 2000);
});
